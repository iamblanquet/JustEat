<?php
  include("create_restaurante.html");
...
$sql = "SELECT * FROM restaurantes WHERE correo_electronico = '" . $_POST["correo_electronico"] . "'";
...
$sql = "INSERT INTO restaurantes (nombre, correo_electronico, contraseña, direccion, numero_telefono, tipo_usuario) VALUES ('" . $_POST["nombre"] . "', '" . $_POST["correo_electronico"] . "', '" . $_POST["contraseña"] . "', '" . $_POST["direccion"] . "', '" . $_POST["numero_telefono"] . "', 'restaurante')";
